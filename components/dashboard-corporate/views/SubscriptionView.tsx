...
import { Check, Crown, AlertCircle, CreditCard, RefreshCw, X, Users } from 'lucide-react'
...
const invoices = [
  { date: '15 May 2026', amount: '₺1.299', status: 'Ödendi' },
  { date: '15 Nis 2026', amount: '₺1.299', status: 'Ödendi' },
  { date: '15 Mar 2026', amount: '₺1.299', status: 'Ödendi' },
  { date: '15 Şub 2026', amount: '₺1.299', status: 'Ödendi' },
]
    ...
    <>
      <div className="space-y-6 max-w-3xl">
        ...
        <div className="bg-white rounded-2xl border border-ink-100 shadow-[0_1px_2px_0_rgba(15,23,42,0.04)] p-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-bold text-lg text-ink-900">Kurumsal Plan</h3>
                  <span className="inline-flex items-center text-[11px] font-medium px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700">
                    Aktif
                  </span>
                </div>
                <p className="text-sm text-ink-500 mt-0.5">Aylık · ₺1.299 / ay · 12 uzman</p>
              </div>
            </div>
            <button
          ...
          <div className="mt-5 p-4 rounded-xl bg-ink-50 border border-ink-100">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4 text-ink-500" strokeWidth={2} />
                <span className="text-sm font-semibold text-ink-900">Uzman Koltuğu</span>
              </div>
              <span className="text-sm font-bold text-brand-600">12 / 15</span>
            </div>
            <div className="h-2 bg-ink-200 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-brand-500 to-violet-500 rounded-full" style={{ width: '80%' }} />
            </div>
            <p className="text-[11px] text-ink-500 mt-1.5">3 boş koltuk kaldı</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-brand-600 to-violet-600 rounded-2xl p-6 text-white">
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div>
              <h3 className="font-bold text-lg">Daha Fazla Uzman Ekle</h3>
              <p className="text-sm text-white/80 mt-1 max-w-sm">
                Kliniğiniz büyüdükçe uzman sayınızı artırın. Her ekstra 5 koltuk için ek ücretlendirme.
              </p>
              <div className="mt-3 space-y-1">
                {['+5 uzman koltuğu', 'Anında aktifleşir', 'İptal edilebilir'].map((f) => (
            ...
            <div className="text-right">
              ...
              <div className="text-sm text-white/70">/ 5 koltuk / ay</div>
            ...
            {invoices.map((inv) => (
              <div key={inv.date} className="flex items-center justify-between py-3">
                <div>
                  ...
                  <p className="text-xs text-ink-500">Kurumsal · Aylık</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="inline-flex items-center text-[11px] font-medium px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700">
                    {inv.status}
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3 mb-5">
              ...
              <p className="text-xs text-amber-800">
                Aboneliğinizi iptal ederseniz dönem sonunda (15 Haziran 2026) tüm kurumsal özellikleriniz ve uzman profilleriniz devre dışı kalacak.
              </p>
            </div>
