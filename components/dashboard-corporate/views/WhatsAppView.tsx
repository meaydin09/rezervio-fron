...
import { MessageCircle, Check, AlertCircle, Smartphone } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-4 flex-wrap">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-ink-500 mt-0.5">
              whatsapp-web.js ile WhatsApp hesabınızı bağlayın. QR kod ile oturum açın.
            </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Bu Ay Gönderilen', value: '1.284', color: 'text-ink-900' },
          { label: 'Başarılı',         value: '1.271', color: 'text-emerald-600' },
