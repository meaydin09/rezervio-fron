interface Props {
  ...
  export default function StatCard({ period, badge, value, label, extra }: Props) {
    return (
      <div className="bg-white rounded-2xl border border-ink-100 shadow-[0_1px_2px_0_rgba(15,23,42,0.04)] p-4 sm:p-5">
        <div className="flex items-center justify-between">
          ...
          <span className={`inline-flex items-center text-[11px] font-medium px-2 py-0.5 rounded-full ${badge.color}`}>{badge.text}</span>
        </div>
